...
//        Courier: PF/EMP + sin EXW, rating en logs, nuevo formato de Costeo
    ...
    if (type==="interactive") {
      ...
      // Modo de transporte (calculadora)
        ...
        const body = [
          ...
          `${fleteUSD>0 ? `Flete ${labelFlete}: USD ${fmtUSD(fleteUSD)}` : "Flete: *sin tarifa* (seguimos el cálculo y te contactamos)"}`,
